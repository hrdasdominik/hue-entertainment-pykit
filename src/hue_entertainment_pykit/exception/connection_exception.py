"""
Defines the BridgeException class, a custom exception for handling errors related to Philips Hue Bridge operations.
It is utilized for capturing and reporting various error conditions during interactions with the Hue Bridge.
"""

class ConnectionException(Exception):
    """
    Custom exception class for errors related to Philips Hue Bridge operations.
